                                ...
                                <?php if ($_SESSION['login_type'] == 1) : ?>
                                    <div class="form-group">
                                        ...
                                        <select name="type" id="type" class="custom-select custom-select-sm">
                                            <option value="3" <?php echo isset($type) && $type == 3 ? 'selected' : '' ?>>Mahasiswa
                                            </option>
                                            ...
                                            <option value="4" <?php echo isset($type) && $type == 4 ? 'selected' : '' ?>>Dosen
                                            </option>
                                            <option value="5" <?php echo isset($type) && $type == 5 ? 'selected' : '' ?>>Mitra
                                            </option>
                                            <option value="6" <?php echo isset($type) && $type == 6 ? 'selected' : '' ?>>Alumni
                                            </option>
                                        </select>
                                    </div>
                                <?php else : ?>
